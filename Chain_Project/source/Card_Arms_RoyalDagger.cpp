...
/* 使用する要素のインクルード */
// ヘッダファイル
#include "Card_Arms_RoyalDagger.h"

// コンストラクタ
Card_Arms_RoyalDagger::Card_Arms_RoyalDagger() : Card_Arms_Base()
{
	/* カード情報の設定 */
	// レアリティ
...
// 効果発動:行動直前
void Card_Arms_RoyalDagger::Effect_Action_Before(std::shared_ptr<Character_Base> Target)
{
	// 引数
	// Target : 効果対象のキャラクター
